 ...
 * سرویس PowerBillInfo — وب سرویس قبض برق با جزئیات
 *
 * @package  APIIR
 * @version  1.0.0
 * @link     https://api.ir
...
if (!function_exists('apiir_power_bill_info')) {
    /**
     ...
     */
    function apiir_power_bill_info($billID, $timeout = APIIR_TIMEOUT)
    {
        return apiir_request('https://s.api.ir/api/sw1/PowerBillInfo', [
            'billID' => $billID,
        ], $timeout);
    }
}
